...
export function parseDoseStrings(doses: string[]): ParsedDose[] {
    const results: ParsedDose[] = [];
...
export async function extractConcepts(text: string): Promise<ExtractedConcepts | null> {
...
`
    ...
    function filterToOntology(values: string[], allowed: string[]): string[] {
